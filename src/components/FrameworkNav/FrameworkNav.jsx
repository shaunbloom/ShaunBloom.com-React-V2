 		...
 		return (
 			<nav className="framework-nav">
		    	<ul>
		            ...
		            <li><a href="http://vanillajs.shaunbloom.com" class="fw-link" data-framework="vanilla" title="Latest build with Webpack, Babel and less using the latest vanillia ES6. Made to look and function exactly as the original JQuery version.">Vanilla '19</a></li>
		        </ul>
	    	</nav>
	    );
 	}
